...
def main():
    ...
    # Resolve to absolute path to avoid asset loading issues
    stage_path = os.path.abspath(options.path)

    omni.kit.async_engine.run_coroutine(open_stage_async(stage_path, options.start_on_play))
