...
from kinematics.signed_distance_field import SignedDistanceField
from kinematics.collision_checker import CollisionChecker
from kinematics.simple_mobile_ik import SimpleMobileIK
...
def main():
    ...
    if sdf_success and collision_success and ik_success:
        ...
        print("\nTo use the system:")
        print("1. Run: ros2 run ia_robot kinematics/mobile_ik_controller.py")
