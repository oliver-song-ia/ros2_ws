...
def generate_launch_description():
    ...
    # Camera serial numbers (found via lsusb and sysfs) - SWAPPED
    camera_01_serial = "CP2R553000ED" 
    ...
    launch1_include = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            "serial_number": camera_01_serial,
            "device_num": "2",
            "sync_mode": "primary",
    ...
    launch2_include = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            "serial_number": camera_02_serial,
            "device_num": "2",
