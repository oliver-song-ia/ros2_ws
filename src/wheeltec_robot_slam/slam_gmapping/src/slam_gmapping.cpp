...
{
    RCLCPP_WARN(this->get_logger(), "startLiveSlamEnd");
...
void SlamGmapping::startLiveSlam() {
    RCLCPP_WARN(this->get_logger(), "startLiveSlam");
...
//        std::bind(&SlamGmapping::laserCallback, this, std::placeholders::_1));
    ...
    subscription_ = this->create_subscription<std_msgs::msg::String>(
        "songkan", rclcpp::SensorDataQoS(),
        std::bind(&SlamGmapping::testCallback, this, std::placeholders::_1));
    ...
    /*scan_filter_ = this->create_subscription<sensor_msgs::msg::LaserScan>(
        "scan", rclcpp::SensorDataQoS(),
        std::bind(&SlamGmapping::laserCallback, this, std::placeholders::_1));*/
    ...
    /*subscription_ = this->create_subscription<std_msgs::msg::String>(
        "songkan", 10,
        std::bind(&SlamGmapping::testCallback, this, _1));   */ 
...
void SlamGmapping::publishLoop(double transform_publish_period){
    RCLCPP_WARN(this->get_logger(), "publishLoop");
    ...
    */
    while (rclcpp::ok()) {
        //rclcpp::spin_some(this->get_node_base_interface());
        //RCLCPP_WARN(this->get_logger(), "publishLoop1");
        publishTransform();
        r.sleep();
    }
}
...
void SlamGmapping::testCallback(std_msgs::msg::String::SharedPtr str){
    RCLCPP_WARN(this->get_logger(), "testCallback");
}

void SlamGmapping::laserCallback(sensor_msgs::msg::LaserScan::ConstSharedPtr scan) {
    RCLCPP_WARN(this->get_logger(), "laserCallback");
    laser_count_++;
