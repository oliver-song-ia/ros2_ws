...
def generate_launch_description():
    ...
    turn_on_robot_use_imu = Node(
        ...
        # prefix=['xterm -e gdb -ex run --args'],      # 调试前缀: 启动xterm终端并通过gdb调试 (已禁用，因为无GUI环境)
        package='turn_on_ia_robot',            # 节点所属功能包
        executable='wheeltec_robot_node',           # 节点可执行文件名称
