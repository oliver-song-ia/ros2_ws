...
3. **ObstacleAvoidanceConfig** (`obstacle_avoidance_config.py`)
...
1. **Start the Controller**:
   ```bash
   ros2 run ia_robot mobile_ik_controller.py
   ```
...
from obstacle_avoidance_config import PresetConfigs
...
├── obstacle_avoidance_config.py    # Configuration and presets
